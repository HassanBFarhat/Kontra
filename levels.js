...
const levelThree = {
    ...
    trigger: [{x: 13421, y: 0, fn: (that) => {ASSET_MANAGER.pauseBackgroundMusic();that.game.addEntity(new TransitionScreen(that.game, levelFour, 0, 0, false));}}]
...
const levelFour = {
    ...
    soldier:[{x: 1600, y: 349}],
    sniper: [{x: 1200, y: 349}],
    trigger: [{x: 13421, y: 0, fn: (that) => {ASSET_MANAGER.pauseBackgroundMusic();that.game.addEntity(new TransitionScreen(that.game, levelFour, 0, 0, true));}}]
};
